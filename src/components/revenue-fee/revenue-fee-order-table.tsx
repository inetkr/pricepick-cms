...
import { RfAmount, RfMallKind } from 'src/components/revenue-fee/revenue-fee-cells';
      ...
      <table id="rf-od-table">
        <thead>
          <tr>
            ...
            <th style={{ width: '15%' }}>제휴몰</th>
            <th style={{ width: '13%' }}>주문번호</th>
            <th style={{ width: '14%' }}>회원</th>
            ...
            orders.map((o) => {
              ...
              return (
                <tr key={o.id}>
                  ...
                  >
                    <span className={RF_STATUS_BADGE[statusKey]}>{RF_STATUS_LABEL[statusKey]}</span>
                  </td>
                </tr>
              );
            })
