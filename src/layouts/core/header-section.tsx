...
const PAGE_META: Record<string, { title: string; bc: string }> = {
  ...
  '/ticket-value': { title: '티켓 가치 설정', bc: '티켓 · 보상' },
  '/ticket-accrual': { title: '티켓 적립 설정', bc: '티켓 · 보상' },
  ...
  '/giftbox-daily': { title: '매일 선물 상자 열기', bc: '티켓 · 보상' },
  '/giftbox-random': { title: '랜덤 선물 상자 열기', bc: '티켓 · 보상' },
  '/points': { title: '포인트 내역', bc: '포인트 관리' },
  '/point-attendance': { title: '출석체크 설정', bc: '포인트 관리' },
  '/point-policy': { title: '포인트 정책', bc: '포인트 관리' },
  '/gifticons': { title: '구매내역', bc: '기프티콘 관리' },
  '/gifticon-unused': { title: '기프티콘 미사용 취소', bc: '기프티콘 관리' },
